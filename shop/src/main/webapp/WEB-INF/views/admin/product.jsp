...
<body>
 <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
	...
	<div class="container">
	<form method="post" name="product" action="productinsert" enctype="multipart/form-data">
		
		<div class="row">
			<div class="col-2">판매상태</div>
			<div class="col">
				<input type="radio" class="form-check-input" name="pState" value="0" checked>판매함
				<input type="radio" class="form-check-input" name="pState" value="1">판매안함
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col">
				<input class="form-control" type="text" name="pColor" placeholder="콤마(,)를 이용하여 구분하세요. 예)빨강,파랑,노랑">
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			...
			<div class="col">
				<textarea class="form-control" name="pDescription" rows="4"></textarea>
			</div>
		</div>
