...
<body>
		...
		<table width="1000" align="center" id="aa">
			...
			<tr>
				<td>주소</td>
				<td align="left">${bvo.juso}, ${bvo.juso_etc}</td>
			</tr>
			<tr>
				<td>배송 시 요청사항</td>
				<td>
			...
			<tr>
				<c:if test="${pvo.yoil==1}">
					<c:set var="yoil" value="일"/>
				</c:if>
				<c:if test="${pvo.yoil==2}">
					<c:set var="yoil" value="월"/>
				</c:if>
				<c:if test="${pvo.yoil==3}">
					<c:set var="yoil" value="화"/>
				</c:if>
				<c:if test="${pvo.yoil==4}">
					<c:set var="yoil" value="수"/>
				</c:if>
				<c:if test="${pvo.yoil==5}">
					<c:set var="yoil" value="목"/>
				</c:if>
				<c:if test="${pvo.yoil==6}">
					<c:set var="yoil" value="금"/>
				</c:if>
				<c:if test="${pvo.yoil==7}">
		...
		<table width="1000" align="center" id="bb">
			...
			<tr align="center">
				<td><img src="../resources/pro/${pvo.pimg}" width="100"></td>
